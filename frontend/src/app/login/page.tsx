  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-zinc-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/3 -left-32 w-72 h-72 bg-indigo-100 dark:bg-indigo-500/5 rounded-full blur-[80px]" />
        <div className="absolute bottom-1/3 -right-32 w-72 h-72 bg-violet-100 dark:bg-violet-500/5 rounded-full blur-[80px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto px-5">
        <div className="text-center mb-7">
          ...
          <p className="mt-1.5 text-[13px] text-zinc-500 dark:text-zinc-400">Sign in to your account</p>
        </div>
